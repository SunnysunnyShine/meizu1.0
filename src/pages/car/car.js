require(["../../static/conf/config.js"], function() {
	require(["jquery", "sw"], function($, Swiper) {
		...
		$(".pnum-add").click(function(){
			...
			//用商品编号来确定找到的是哪一个商品
			//找到点击按钮下一个元素中的商品编号
			var pcode_find = $(this).parent().parent().siblings(".phone-msg").find(".goods-name").html();

			//先获取cookie中所有的元素,就行对比找到点击的是哪一个元素
			var lists = JSON.parse(getCookie("product"));

			//findIndex()方法返回返回结果为ture的下标
