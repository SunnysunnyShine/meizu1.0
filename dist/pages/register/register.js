...
require(["../../static/conf/config.js"], function () {
  require(["jquery", "sw"], function ($, Swiper) {
    ...
    var dom = $(".content").not($("#numberReg")); //绑定单击事件
    //console.log($("#btn-left"));

    $("#btn-left").bind("click", function () {
      var username = $("#numberReg").val(); //console.log("avd");
      ...
      if (nameReg.test(username)) {
        ...
        array.push(obj);
        flag1 = true; //$("#numberReg").value = "";

        window.localStorage.userArr = JSON.stringify(array);
        $("#btn-left").removeClass("left-blue").addClass("left-green"); //css("border-color","#18A452");
